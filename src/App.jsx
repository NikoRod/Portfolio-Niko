...
const translation = {
  es:{
    ...
    projectDesc1: "To Do List para anotar tus tareas. Desarrollada con React + Vite, JS y TailwindCSS.",
  ...
  en:{
    ...
    projectDesc1: "To Do List. Developed with React + Vite, JS y TailwindCSS.",
    projectDesc2: "Freelance proyect for a real textile and sublimation shop. Developed with React, ReactRouter, JS y CSS.",
